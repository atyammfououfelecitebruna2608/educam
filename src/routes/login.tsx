    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#0a0a0b]">
      ...
      <div className="w-full max-w-md relative z-20 px-6">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-black tracking-tighter text-gradient mb-2">PensionVerify</h1>
          <p className="text-muted-foreground font-medium uppercase tracking-[0.2em] text-[10px]">Portail d'Administration</p>
        </div>

        <Card className="p-10 border-white/5 bg-white/5 backdrop-blur-2xl shadow-2xl relative overflow-hidden group hover:border-white/10 transition-colors duration-500 rounded-3xl">
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="email" className="text-white/50 text-[10px] uppercase tracking-widest font-black ml-1">Identifiant Email</Label>
              <Input 
                id="email" 
                type="email" 
                placeholder="admin@rectorat.edu"
                className="bg-white/5 border-white/10 text-white placeholder:text-white/20 h-13 rounded-xl focus:ring-primary/40 focus:border-primary/40 transition-all" 
                required 
                value={email} 
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <Label htmlFor="password" className="text-white/50 text-[10px] uppercase tracking-widest font-black ml-1">Clé d'Accès</Label>
              </div>
              <Input 
                id="password" 
                type="password" 
          ...
          <div className="mt-10 pt-8 border-t border-white/5 text-center">
            <button 
              className="text-white/60 hover:text-primary text-xs font-bold transition-all duration-300 uppercase tracking-widest" 
        ...
        <p className="mt-12 text-center text-[10px] text-white/20 uppercase tracking-[0.4em] font-black">
